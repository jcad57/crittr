-- Ensure invitees receive in-app notifications when an invite is created or when
-- invited_user_id is backfilled after signup (lookup_user_by_email + trigger path).
...
BEGIN
  ...
  ELSIF TG_OP = 'UPDATE' THEN
    -- Backfill: email matched a user after profile/signup linked invited_user_id
